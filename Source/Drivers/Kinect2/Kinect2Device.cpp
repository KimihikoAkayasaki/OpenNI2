    ...
    m_perfCounter(0)
{
  ...
  m_sensors[0].pSupportedVideoModes[1].resolutionX = 512;
  m_sensors[0].pSupportedVideoModes[1].resolutionY = 424;
  ...
  m_sensors[1].pSupportedVideoModes[1].resolutionX = 960;
  m_sensors[1].pSupportedVideoModes[1].resolutionY = 540;

  m_sensors[1].pSupportedVideoModes[2].pixelFormat = ONI_PIXEL_FORMAT_RGB888;
  m_sensors[1].pSupportedVideoModes[2].fps = DEFAULT_FPS;
  m_sensors[1].pSupportedVideoModes[2].resolutionX = 512;
  m_sensors[1].pSupportedVideoModes[2].resolutionY = 424;
